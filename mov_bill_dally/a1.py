    ...
    for i, bar in enumerate(bars):
        ...
        if bar.idx > last_idx:
            if state != "up":
                ...
                changed_at_seq = bar.seq  # trend changed here
...
if __name__ == "__main__":
    ...
    for r in results:
        if r["last_up_high_price"] is None:
            print(f"{r['seq']}  {r['date']}  {r['price']}  state={r['state']}  "
                  f"changed_at_seq={r['changed_at_seq']}  last_up_high=None")
        else:
            print(f"{r['seq']}  {r['date']}  {r['price']}  state={r['state']}  "
                  f"changed_at_seq={r['changed_at_seq']}  "
